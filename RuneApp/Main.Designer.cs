namespace RuneApp
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
			...
			this.toolStripButton1 = new StyledToolStripButton();
			this.toolStripButton2 = new StyledToolStripButton();
			this.toolStripButton7 = new StyledToolStripButton();
			this.toolStripButton14 = new StyledToolStripButton();
			this.toolStripButton15 = new StyledToolStripButton();
			this.unequipMonsterButton = new StyledToolStripButton();
			this.tabRunes = new System.Windows.Forms.TabPage();
			this.toolStrip3 = new System.Windows.Forms.ToolStrip();
			this.RuneTab_UnfilterButton = new StyledToolStripButton();
			this.RuneTab_LockButton = new StyledToolStripButton();
			this.RuneTab_SaveButton = new StyledToolStripButton();
			...
			this.toolStripButton5 = new StyledToolStripButton();
			...
			this.tsBtnLoadsRemove = new StyledToolStripButton();
			this.tsBtnLoadsClear = new StyledToolStripButton();
			this.tsBtnLoadsLock = new StyledToolStripButton();
			this.tsBtnRuneStats = new StyledToolStripButton();
			this.tsBtnLoadsSave = new StyledToolStripButton();
			this.tsBtnLoadsLoad = new StyledToolStripButton();
			this.groupBox3 = new System.Windows.Forms.GroupBox();
			this.toolStrip6 = new System.Windows.Forms.ToolStrip();
			this.tsBtnBuildsMoveUp = new StyledToolStripButton();
			this.tsBtnBuildsMoveDown = new StyledToolStripButton();
			this.toolStripSeparator2 = new System.Windows.Forms.ToolStripSeparator();
			this.tsBtnBuildsRemove = new StyledToolStripButton();
			this.tsBtnBuildsRunOne = new StyledToolStripButton();
			this.toolStripSeparator1 = new System.Windows.Forms.ToolStripSeparator();
			this.tsBtnBuildsSave = new StyledToolStripButton();
			this.tsBtnBuildsUnlock = new StyledToolStripButton();
			this.tsBtnBuildsRunAll = new StyledToolStripButton();
			this.tsBtnBuildsRunUpTo = new StyledToolStripButton();
			this.tsBtnBuildsResume = new StyledToolStripButton();
			this.tsBtnFindSpeed = new StyledToolStripButton();
        ...
        private StyledToolStripButton toolStripButton1;
        private StyledToolStripButton toolStripButton2;
        private System.Windows.Forms.ToolStrip toolStrip3;
        private StyledToolStripButton RuneTab_UnfilterButton;
        private System.Windows.Forms.ListView loadoutList;
        private System.Windows.Forms.TabPage tabBuilds;
        private System.Windows.Forms.GroupBox groupBox2;
        private System.Windows.Forms.ToolStrip toolStrip4;
        private StyledToolStripButton tsBtnLoadsClear;
        private System.Windows.Forms.ToolStrip toolStrip5;
        private StyledToolStripButton toolStripButton5;
        ...
        private StyledToolStripButton toolStripButton7;
        private System.Windows.Forms.GroupBox groupBox3;
        private System.Windows.Forms.ToolStrip toolStrip6;
        private StyledToolStripButton tsBtnBuildsMoveUp;
        ...
        private StyledToolStripButton tsBtnBuildsRunOne;
        private StyledToolStripButton tsBtnBuildsSave;
        private StyledToolStripButton tsBtnBuildsRemove;
        private System.Windows.Forms.ToolStripSeparator toolStripSeparator1;
        private StyledToolStripButton tsBtnBuildsUnlock;
        private StyledToolStripButton tsBtnBuildsRunAll;
		private StyledToolStripButton tsBtnLoadsRemove;
        private StyledToolStripButton toolStripButton14;
        private StyledToolStripButton toolStripButton15;
        private StyledToolStripButton tsBtnBuildsMoveDown;
        ...
        private StyledToolStripButton RuneTab_LockButton;
        private StyledToolStripButton RuneTab_SaveButton;
        private StyledToolStripButton unequipMonsterButton;
        private StyledToolStripButton tsBtnLoadsLock;
        private StyledToolStripButton tsBtnBuildsResume;
        private StyledToolStripButton tsBtnBuildsRunUpTo;
        ...
        private StyledToolStripButton tsBtnRuneStats;
        ...
        private StyledToolStripButton tsBtnLoadsSave;
        private StyledToolStripButton tsBtnLoadsLoad;
        private RuneBox runeEquipped;
        private RuneBox runeInventory;
        private System.Windows.Forms.CheckBox findGoodRunes;
		private StyledToolStripButton tsBtnFindSpeed;
